...
opcode_entry opcode_table [512] = {
  ...
  /* 0x08 */	IDEXW(G2E, or, 1), IDEX(G2E, or), IDEXW(E2G, or, 1), IDEX(G2E, or),
  ...
  /* 0x24 */	IDEXW(I2a, and, 1), IDEX(I2a, and), EX(seg_override), EMPTY,
  /* 0x28 */	IDEXW(G2E, sub, 1), IDEX(G2E, sub), IDEXW(E2G, sub ,1), IDEX(E2G, sub),
  /* 0x2c */	IDEXW(I2a, sub, 1), IDEX(I2a, sub), EX(seg_override), EMPTY,
  /* 0x30 */	IDEXW(G2E, xor, 1), IDEX(G2E, xor), IDEXW(E2G, xor, 1), IDEX(E2G, xor),
  /* 0x34 */	IDEXW(I2a, xor, 1), IDEX(I2a, xor), EX(seg_override), EMPTY,
  /* 0x38 */	IDEXW(G2E, cmp, 1), IDEX(G2E, cmp), IDEXW(E2G, cmp, 1), IDEX(E2G, cmp),
  /* 0x3c */	IDEXW(I2a, cmp, 1), IDEX(I2a, cmp), EX(seg_override), EMPTY,
  ...
  /* 0x64 */	EX(seg_override), EX(seg_override), EX(operand_size), EMPTY,
  ...
  /* 0x20 */	IDEX(G2E, mov_cr2r), EMPTY, IDEX(mov_E2G, mov_r2cr), EMPTY,
  ...
  /* 0xac */	IDEX(Ib_G2E, shrd), IDEX(cl_G2E, shrd), EMPTY, IDEX(E2G, imul2),
